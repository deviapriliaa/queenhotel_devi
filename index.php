  ...
  <div class="content-wrapper">
	...
	if(isset($_GET['pesan'])){
        ...
        <h5><i class="icon fas fa-exclamation-triangle"></i>PERINGATAN !!!</h5>
            Mohon maaf anda tidak dapat mengakses halaman ini. Silahkan Login terlebih dahulu ! 
      </div>
		<?php }} ?>
        </div>
      </div>
      ...
      <div class="col-md-12">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="assets/gambar/hotel1.jpg" alt="First slide" height="500">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/hotel2.jpg" alt="Second slide" height="500">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/hotel3.jpg" alt="Four slide" height="500">
                    </div>
                  </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group">
              <label>Email pemesanan</label>
              <input type="text" name="email_pemesan" class="form-control" placeholder="masukkan email pemesan" required>
            </div>
            <div class="form-group">
              <label>No. Handphone</label>
              <input type="text" name="hp_pemesan" class="form-control" placeholder="masukkan nomor handphone" required>
            </div>
            <div class="form-group">
