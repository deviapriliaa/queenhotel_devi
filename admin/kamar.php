        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="tambah_kamar.php" enctype="multipart/form-data">
              ...
              <div class="form-group"> <label>Jumlah Kamar </label> <input type="text" class="form-control" name="qty" placeholder="Masukkan Jumlah kamar yang ingin ditambahkan"> </div>
              <div class="form-group">
