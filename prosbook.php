        ...
        <div class="content">
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" style="font-family:'Old Standard TT', serif;">Queen Hotel</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div>
                <br><br>
                                    ...
                                    <div class="col md-12">        
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <p>No HP Pemesan : <?php echo $data['hp_pemesan']; ?></p>
                                                        ...
                                                        <table border="1" class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Jumlah Kamar Yang Di Pesan</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                ...
                                                <div
                                                    style=" background-color:#DEDEDA; border: 3px darkgrey double; padding: 10px; text-align: left;">
                                                    Silahkan print halaman ini dan tunjukkan bukti pemesanan ini kepada resepsionis saat akan check-in.
                                                </div>
                                                <br>
